---
title: Generate Funding Infrastructure Production Deployment Announcement
description: Generate Teams markdown production deployment announcements for all Funding infrastructure repositories by comparing git tags
tags: [deployment, notification, teams, production, announcement, funding, infrastructure]
---

# Generate Funding Infrastructure Production Deployment Announcement
...
**Example:**
```bash
python3 /home/saldave/projects/.vscode/.github/scripts/generate_prod_deployment_announcement.py 2025-12-02 21:00
```
...
1. Ask for deployment date (YYYY-MM-DD) and time (HH:MM) if not provided — **default time is 21:00 (9:00 P.M. MT)**
   - **Time zone is always Mountain Time (MT). Never use any other time zone.**
...
**Example interaction:**
```
User: #file:generate-funding-infra-prod-announcement.prompt.md
Assistant: [Asks for date and time]
User: 2025-12-02 at 21:00
...
```
#file:generate-funding-infra-prod-announcement.prompt.md 2025-12-05 21:00
```
...
- Default deployment time: 21:00 (9:00 P.M. MT) is outside working hours
